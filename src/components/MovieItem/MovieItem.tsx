...
export const MovieItem: FC<MovieItemProps> = ({ isDetailsPage }) => {
	...
	return (
		<MovieItemContainer>
			{!isDetailsPage ? (
				<RedirectWrapper onClick={() => handlePushToDetailsPage(1)}>
					{cardMedia}
				</RedirectWrapper>
			) : (
				cardMedia
			...
			<MovieItemContent onClick={(e) => e.stopPropagation()}>
				<CardHeader
					title="Movie Title (2009)"
					subheader="Drama, Thriller, Comedy | 90 minutes"
				/>
				<CardContent>
					<MovieItemContentDescription>
						Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Exercitationem hic saepe necessitatibus. Aperiam, excepturi! Iusto
						odio fugiat obcaecati temporibus impedit reiciendis beatae. A
						deleniti nesciunt impedit beatae corporis soluta. Molestiae.
					</MovieItemContentDescription>
					<VisitOfficialSiteLink href="#">
						Visit official site
					</VisitOfficialSiteLink>
				</CardContent>
